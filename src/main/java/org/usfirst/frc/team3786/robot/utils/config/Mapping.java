...
public class Mapping<K> {
	 ...
	 */
	public Mapping(String identifier, K defaultValue) {
	 ...
	 */
	public Mapping(String identifier, K defaultValue, Runnable runnable) {
	...
	public Mapping(String identifier, K defaultValue, Runnable runnable, boolean runFirstTime) {
	 ...
	 */
	public Mapping(String identifier, K defaultValue, Consumer<K> consumer) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Mapping(String identifier, K defaultValue, Consumer<K> consumer, boolean runFirstTime) {
		entry = Config.table.getEntry(identifier);
		this.defaultValue = defaultValue;
		Object conf = Config.getConfig().get(identifier);
		if (conf != null)
